    ...
    <body>
        <div class="panel">
            ...
            <table class="bordered_table">
                ...
                <tbody>
                    <% 
						...
						session.setAttribute("personal", request.getParameter("id"));
						System.out.println("s: "+session.getAttribute("personal"));
            ...
            <div class="margin_top_15px">
                <a id="fileUpload" class="hyperLink" href="<%=request.getContextPath()%>/uploadedFilesServlet">Back</a>
            </div>
        </div>
    </body>
</html>